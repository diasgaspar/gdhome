<html>
  ...
  callback: function () {
    ...
    data.addRow([new Date('04/08/2001'), 4, 5, 9, 0]);
    data.addRow([new Date('04/09/2001'), 4, 5, 19, 0]);
    data.addRow([new Date('04/10/2001'), 4, 2, 34, 0]);
    data.addRow([new Date('04/11/2001'), 4, 2, 91, 0]);
    data.addRow([new Date('04/12/2001'), 4, 5, 9, 0]);
